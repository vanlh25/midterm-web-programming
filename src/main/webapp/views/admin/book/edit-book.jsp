...
<div class="admin-content mt-5">
    ...
    <form action="${pageContext.request.contextPath}/admin/book/edit" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div>
                <img id="coverPreview" src="<c:out value='${pageContext.request.contextPath}/image?fname=${book.coverImage}'/>" 
                     alt="${book.title}" style="width:100px;height:150px;object-fit:cover;margin-bottom:10px;"/>
            </div>
