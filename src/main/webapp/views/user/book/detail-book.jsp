...
<div class="user-content mt-5">
    ...
    <a href="${pageContext.request.contextPath}/user/books" class="btn btn-primary mb-3">← Quay lại</a>
    ...
    <div class="book-detail-card">
        ...
        <div class="book-info">
            ...
            <c:if test="${not empty currentUser}">
                <form action="${pageContext.request.contextPath}/user/book/detail" method="post">
