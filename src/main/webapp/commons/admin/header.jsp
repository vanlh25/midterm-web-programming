		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					...
					<li><a href="${pageContext.request.contextPath}/admin/book/list">Sản phẩm</a></li>
					<c:if
					...
					<li><c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/admin/profile">${sessionScope.account.fullname}</a> |
                                <a
